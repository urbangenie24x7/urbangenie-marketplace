...
INSERT INTO services (category_id, title, category, subcategory, description, price, duration, image_url, rating, total_reviews, service_type) VALUES
-- Beauty & Salon
...
((SELECT id FROM categories WHERE name = 'Clothing & Accessories'), 'Custom Tailoring', 'Clothing & Accessories', 'Tailoring Services', 'Expert alterations and custom stitching', 599, '3-5 days', 'https://images.unsplash.com/photo-1558769132-cb1aea41f9e5?w=400&h=300&fit=crop', 4.6, 98, 'platform'),
((SELECT id FROM categories WHERE name = 'Clothing & Accessories'), 'Dress Alteration', 'Clothing & Accessories', 'Tailoring Services', 'Professional dress alterations', 299, '1-2 days', 'https://images.unsplash.com/photo-1594633312681-425c7b97ccd1?w=400&h=300&fit=crop', 4.7, 156, 'platform'),
...
((SELECT id FROM categories WHERE name = 'Home Services'), 'Electrical Work', 'Home Services', 'Repairs', 'Electrical installation and repair', 699, '2 hours', 'https://images.unsplash.com/photo-1621905251189-08b45d6a269e?w=400&h=300&fit=crop', 4.7, 167, 'platform'),
...
((SELECT id FROM categories WHERE name = 'Electronics & Gadgets'), 'Laptop Repair', 'Electronics & Gadgets', 'Device Repair', 'Professional laptop repair', 1299, '4 hours', 'https://images.unsplash.com/photo-1588872657578-7efd1f1555ed?w=400&h=300&fit=crop', 4.5, 123, 'platform'),
...
((SELECT id FROM categories WHERE name = 'Education & Training'), 'Guitar Lessons', 'Education & Training', 'Music', 'Learn guitar with expert instructor', 799, '60 mins', 'https://images.unsplash.com/photo-1493225457124-a3eb161ffa5f?w=400&h=300&fit=crop', 4.7, 134, 'platform'),
...
((SELECT id FROM categories WHERE name = 'Pet Services'), 'Pet Walking', 'Pet Services', 'Care', 'Daily pet walking service', 299, '30 mins', 'https://images.unsplash.com/photo-1601758228041-f3b2795255f1?w=400&h=300&fit=crop', 4.5, 89, 'platform'),
...
((SELECT id FROM categories WHERE name = 'Event Services'), 'Decoration', 'Event Services', 'Decoration', 'Event decoration and setup', 1999, '3 hours', 'https://images.unsplash.com/photo-1530103862676-de8c9debad1d?w=400&h=300&fit=crop', 4.7, 167, 'platform'),
...
((SELECT id FROM categories WHERE name = 'Transportation'), 'Moving Service', 'Transportation', 'Moving', 'Professional moving and packing', 2499, '4 hours', 'https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=400&h=300&fit=crop', 4.6, 189, 'platform')
